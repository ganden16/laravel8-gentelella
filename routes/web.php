...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
    ...
    Route::put('products/{id}', 'ProductController@put')->name('products.put');
    Route::delete('products/{id}', 'ProductController@delete')->name('products.delete');

	 //Orders
    Route::get('orders', 'OrderController@index')->name('orders');
    Route::get('orders/details/{order}', 'OrderController@show')->name('orders.show');
    Route::get('orders/create', 'OrderController@create')->name('orders.create');
    Route::post('orders', 'OrderController@post')->name('orders.post');
    Route::get('orders/edit/{order}', 'OrderController@edit')->name('orders.edit');
    Route::put('orders/{id}', 'OrderController@put')->name('orders.put');
